...
def visualize_results(cnt, result, file_path, true_label=None):
    ...
    # 1. 柱状图
    ax1 = axes[0, 0]
    labels = [modulation_labels[i] for i in range(13)]
...
if __name__ == "__main__":
    # 测试单个文件
    mat_file_path = r'D:\RadioData\ook_dp.mat'
    result, cnt = test_and_visualize(mat_file_path, true_label=11)  # 8ASK的标签是2
